...
Credential rotation with Secrets Manager and RDS is handled via the db template in the `addons` directory.   This template creates a Lambda function to do the rotation.  Replace the current db.yml with the following code:
