...
#### Set an environment variable for the code to deploy the frontend service on the EC2 nodes in the cluster
```bash
export EC2MODE=True
```
...
class FrontendService(core.Stack):
    ...
    def __init__(self, scope: core.Stack, id: str, **kwargs):
        ...
        # This high level construct will build everything required to ensure our container is load balanced and running as an ECS service running on EC2
